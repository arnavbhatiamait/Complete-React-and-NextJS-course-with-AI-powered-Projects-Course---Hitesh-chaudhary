...
export async function deleteUser(id: string) {
    ...
    const res = await fetch(`https://69ce152e33a09f831b7cddf2.mockapi.io/api/users/users/${id}`, {
        method: "DELETE",
        next: { tags: ["users"] }
    });
    updateTag("users");
...
// Form-friendly server action wrappers (accept FormData from <form action={...}>)
