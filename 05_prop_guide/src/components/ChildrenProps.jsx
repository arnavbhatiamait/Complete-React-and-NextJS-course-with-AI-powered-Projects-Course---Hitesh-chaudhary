...
function Container({ children, layout = 'vertical' }) {
    ...
    return (
        <div className={`p-4 ${layoutClasses[layout]}`}>{children}</div>
    )
}
...
function ChildrenProps() {
    return (
        <section className="p-8 bg-white rounded-xl shadow-lg">
            ...
            <p className="text-gray-600 mb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam perferendis consequatur quisquam nihil tempora eveniet.</p>
            <div className="space-y-6">
                <div className="">
                    <h3 className="text-xl font-semibold mb-4 text-gray-700">Card component with Children :</h3>
                    <Container layout='grid'>
                        <Card title='User Profile' color='blue'>
                            <p className='mb-2'>
                                <strong>Name:</strong> Arnav Bhatia
                            </p>
                            <p className='mb-2'>
                                <strong>Email:</strong> arnav.bhatia@example.com
                            </p>
                            <p className='mb-2'>
